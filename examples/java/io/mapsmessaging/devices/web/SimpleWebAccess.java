...
public class SimpleWebAccess {
  ...
  private void handleGetSchema(Context ctx, DeviceController deviceController) {
    com.google.gson.JsonObject schemaObject = deviceController.getSchema().getSchema();
