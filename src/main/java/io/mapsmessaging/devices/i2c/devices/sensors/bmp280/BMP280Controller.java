...
public class BMP280Controller extends I2CDeviceController {
  ...
  public XRegistrySchemaVersion getSchema() {
    ...
    config.setDescription("i2c device BMP280 Pressure and Temperature Sensor https://www.bosch-sensortec.com/products/environmental-sensors/pressure-sensors/bmp280/");
