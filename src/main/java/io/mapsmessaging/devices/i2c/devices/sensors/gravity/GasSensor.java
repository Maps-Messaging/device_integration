...
public class GasSensor extends I2CDevice implements Sensor {
  ...
  public GasSensor(AddressableDevice device) throws IOException {
    ...
    FloatSensorReading concentration = new FloatSensorReading(sensorType.getGasType(), sensorType.getUnits(), sensorType.getMinimumRange(), sensorType.getMaximumRange(), sensorType.getResolution(), this::getConcentration);
