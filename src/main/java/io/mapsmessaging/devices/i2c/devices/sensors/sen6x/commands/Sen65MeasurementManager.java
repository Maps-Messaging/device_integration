...
public class Sen65MeasurementManager extends Sen6xMeasurementManager{
  public Sen65MeasurementManager(Sen6xCommandHelper helper) {
    super(helper, 0x0446, 24 );
  }


  @Override
  protected MeasurementBlock processResponse(byte[] raw) throws IOException {
    if (raw.length < 16) throw new IOException("Invalid measurement block size");
