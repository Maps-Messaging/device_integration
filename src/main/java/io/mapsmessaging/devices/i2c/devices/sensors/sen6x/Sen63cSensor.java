...
import io.mapsmessaging.devices.i2c.devices.sensors.sen6x.commands.Sen63cMeasurementManager;
import io.mapsmessaging.devices.i2c.devices.sensors.sen6x.commands.Sen6xMeasurementManager;
import io.mapsmessaging.devices.impl.AddressableDevice;

public class Sen63cSensor extends Sen6xSensor {


  public Sen63cSensor(AddressableDevice device) {
    super(device);
  ...
  protected Sen6xMeasurementManager contructMeasurementManager(Sen6xCommandHelper helper) {
    return new Sen63cMeasurementManager(helper);
  }
}
