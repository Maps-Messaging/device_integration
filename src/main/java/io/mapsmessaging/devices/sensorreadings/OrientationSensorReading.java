...
public class OrientationSensorReading extends SensorReading<Orientation> {
  ...
  public OrientationSensorReading(String name, String unit, String description, Orientation example, boolean readOnly, ReadingSupplier<Orientation> valueSupplier) {
